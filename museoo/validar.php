...
$log_consult = mysqli_query($datos_bd, "SELECT * FROM `usuario` WHERE `nombre_usuario` = '$nombre' and `contraseña` ='$password'");
...
if ($lista_consulta !== null && $lista_consulta["nombre_usuario"] == $nombre) {
