    ...
    <div class="container mt-5 custom-form">
        <form action="actualizarDatosSerie.php" method="post">
            ...
            <div class="form-group">
                ...
                <input class="custom-input" type="text" id="nombre_serie" name="nombre_serie" placeholder="   Nombre de la serie"required><br><br>
                <label class="custom-label text-center">Nuevo Valor:</label>
                <input class="custom-input" type="text" name="nuevo_valor" placeholder="   Nuevo nombre de la serie" required>
