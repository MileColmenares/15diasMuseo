...
<body>
    ...
    <br>
    <h1 class="text-center">Eliminar datos del subfondo</h1>

    <!--formulario para eliminar datos-->
    <div class="container mt-5 custom-form">
        <form action="deleteSubfondo.php" method="get">

            <div class="form-group">
                <label class="custom-label text-center" for="nombre_subfondo">Nombre del Registro a Eliminar:</label>
                <input class="custom-input" type="text" name="nombre_subfondo"  required><br><br>
