...
<link rel="stylesheet" type="text/css" href="css/PRUEBA.css">
    ...
    // obtener datos
    $sql = "SELECT * FROM unidad_documental1,fondo f,subfondo sf,serie s,subserie ss WHERE id_documento AND sf.id_subfondo=s.id_subfondo AND ss.id_serie=s.id_serie ";
