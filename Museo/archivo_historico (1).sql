...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-11-2023 a las 18:35:00
...
CREATE TABLE `unidad_documental` (
  ...
  `intervenciones` varchar(250) NOT NULL,
...
INSERT INTO `unidad_documental` (`id_documento`, `id_fondo`, `id_subfondo`, `id_serie`, `id_subserie`, `nombre_documento`, `fecha_inicio`, `fecha_final`, `ubicacion`, `volumen_soporte`, `nombre_productor`, `nombre_creador`, `forma_ingreso`, `descripcion`, `estado_conservacion`, `condicion_acceso`, `condicion_reproduccion`, `descripcion_estado`, `intervenciones`, `recomendaciones`, `documentos_relacionados`, `notas`, `fecha_registro`, `resp_registro`, `resp_control`) VALUES
(26, 0, 1, 1, 1, 1, '2023-11-13', NULL, 'SDFSDF', 'ASDASDASD', 'sdfs', 'Jose Hernandez ', 'asdasd', 'nose', '', 'asdasda', 'muy sano ', 'muy sano ', 'ninguna', 'SDFSDF', 'gghfhfghf', 0, '2023-11-21', 'asdasda', 'asdasd'),
(27, 0, 1, 1, 1, 1, '2023-11-16', NULL, 'SDFSDF', 'ASDASDASD', 'sdfs', 'Jose Hernandez ', 'fsd', 'asdasdas', '', 'JGHJGHJ', 'muy sano ', 'muy sano ', 'hfghfghfg', 'SDFSDF', 'La genética textual de El gaucho Martín Fierro.', 0, '2023-11-21', 'sdfsdf', 'sdfsdf'),
(29, 0, 1, 6, 1, 1, '2023-10-29', NULL, 'asdasd', 'ASDASDASD', ' Hernán Domínguez', 'Jose Hernandez ', 'JGHJGH', 'nose', '', 'asdasd', 'muy sano ', 'muy sano ', 'ninguna', 'SDFSDF', 'La genética textual de El gaucho Martín Fierro.', 0, '2023-11-09', 'si', 'no'),
(30, 0, 1, 5, 1, 1, '2023-11-09', NULL, 'asdasd', 'ASDASDASD', ' Hernán Domínguez', 'Jose Hernandez ', 'SDFSDF', 'asdasdasd', '', 'asdasda', 'muy sano ', 'muy sano ', 'JGHJGHJ', 'asdasd', 'La genética textual de El gaucho Martín Fierro.', 0, '2023-11-07', 'SDFSDF', 'SDFSDF');
